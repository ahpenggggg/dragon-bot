...
// ── Bet sizing ────────────────────────────────────────────────────────────────
// If no high tier: pick single best normal signal
// If high tier exists: pool all signals (high + any new normal) together,
//   sum high tier losses * 1.1, split equally across ALL signals in pool
...
if (high.length === 0) {
    // No high tier — pick single best normal signal
    ...
    // High tier active — pool everyone together, split equally
